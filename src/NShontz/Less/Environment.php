...
class Environment {
    ...
    /**
     * The LESS finder implementation.
     * 
     ...
     * @var array
     */
    protected $extensions = array('less' => 'less');
    ...
    /**
     * Create a new LESS environment instance.
     *
    ...
    /**
     * Get the appropriate LESS engine for the given path.
     *
     * @param  string  $path
    ...
    /**
     * Get the extension used by the LESS file.
     *
     * @param  string  $path
     * @return string
     */
    ...
    /**
     * Add a location to the array of LESS locations.
     *
    ...
    /**
     * Register a valid LESS extension and its engine.
     *
